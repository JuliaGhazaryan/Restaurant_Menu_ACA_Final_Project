            ...
            <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                ...
                <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
                    ...
                    <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex item-center gap-2">
                        <img src="https://firebasestorage.googleapis.com/v0/b/menu-d0d09.appspot.com/o/Images%2F1664394140513-f1.png?alt=media&token=16eeb8ce-7075-4a30-8b89-16c22aaadc31"
                        className="w-20 h-20 max-w-[60px] rounded-full object-contain"
                             alt=""
                        />
                        {/*name section*/}
                        <div className="flex flex-col gap-2">
                            <p className="text-base text-gray-50">Some item</p>
                        ...
                        <div className="group flex items-center gap-2 ml-auto cursor-pointer">
                            ...
                            <p className="w-5 h-5 rounded-sm bg-cartBg text0gray-50 flex items-center justify-center">
                                1
                            </p>
